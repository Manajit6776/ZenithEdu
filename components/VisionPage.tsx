...
const colorMap: Record<string, { bg: string; text: string; border: string; gradient: string; soft: string }> = {
  blue:   { bg: 'bg-rose-500/10 dark:bg-indigo-600/15',   text: 'text-rose-600 dark:text-indigo-400',   border: 'border-rose-100 dark:border-indigo-500/20',   gradient: 'from-rose-500 to-rose-700',     soft: 'from-rose-500/10 to-transparent' },
  violet: { bg: 'bg-rose-500/10 dark:bg-indigo-600/15', text: 'text-rose-600 dark:text-indigo-400', border: 'border-rose-100 dark:border-indigo-500/20', gradient: 'from-rose-500 to-rose-700', soft: 'from-rose-500/10 to-transparent' },
  emerald:{ bg: 'bg-emerald-500/10 dark:bg-indigo-600/15', text: 'text-emerald-600 dark:text-indigo-400', border: 'border-rose-100 dark:border-indigo-500/20', gradient: 'from-emerald-500 to-emerald-700', soft: 'from-emerald-500/10 to-transparent' },
  rose:   { bg: 'bg-rose-500/10 dark:bg-indigo-600/15',   text: 'text-rose-600 dark:text-indigo-400',   border: 'border-rose-100 dark:border-indigo-500/20',   gradient: 'from-rose-500 to-rose-700',     soft: 'from-rose-500/10 to-transparent' },
};
      ...
      <section className="relative pt-20 pb-28 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <motion.p
            ...
            className="text-xl text-rose-950/60 dark:text-indigo-400/60 max-w-3xl mx-auto font-black uppercase tracking-tight">
            We posit that every institution — from a 50-pupil academy to a 50,000-student conglomerate — necessitates world-class cognitive infrastructure. ZenithEdu is the architectural response.
          </motion.p>
          ...
          >
            <p className="text-lg font-semibold text-slate-800 dark:text-white italic leading-relaxed">
              "Our mission is not to digitise education management. It's to fundamentally free educators from administrative burden — so they can focus entirely on what only humans can do: <span className="text-rose-600 dark:text-indigo-400 not-italic font-black">inspire learners</span>."
            </p>
            <p className="mt-3 text-[10px] font-black uppercase tracking-widest text-rose-700/40 dark:text-slate-900">— ZenithEdu Founding Principle</p>
          </motion.blockquote>
        </div>
      </section>
      ...
      <section className="bg-slate-50 dark:bg-slate-900/40 border-y border-slate-100 dark:border-white/5 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-600 dark:text-slate-400 max-w-xl mx-auto font-black uppercase tracking-[0.2em] text-[10px]">Our public commitment to where ZenithEdu is headed. Built with our community, for our community.</p>
          </div>

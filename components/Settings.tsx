      ...
      <div className="bg-white/40 dark:bg-slate-800 rounded-xl shadow-xl shadow-rose-200/5 border border-rose-200/30 dark:border-slate-700 divide-y divide-rose-100 dark:divide-slate-700">
        ...
        <div className="p-6 bg-slate-50 dark:bg-slate-900/50 flex justify-end">
          <button
            ...
            className="flex items-center gap-2 bg-rose-600 hover:bg-rose-500 dark:bg-indigo-600 dark:hover:bg-indigo-500 text-white px-8 py-3 rounded-xl transition-all shadow-lg shadow-rose-200/50 dark:shadow-indigo-500/20 font-black uppercase text-[10px] tracking-widest active:scale-95"
          >

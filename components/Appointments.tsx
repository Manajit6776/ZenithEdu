...
export const Appointments: React.FC = () => {
  ...
  const getStatusColor = (status: Appointment['status']) => {
    switch (status) {
      ...
      case 'Approved': return 'bg-rose-100/50 text-rose-900 dark:bg-rose-500/10 dark:text-rose-400 border-rose-200/50';
      case 'Rejected': return 'bg-red-100/50 text-red-900 dark:bg-red-500/10 dark:text-red-400 border-red-200/50';
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
        ...
        <p className="text-rose-800 dark:text-slate-500 animate-pulse font-black uppercase text-xs tracking-widest">Loading Appointments</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-[11px] font-black text-rose-700/60 dark:text-slate-500 uppercase tracking-widest mt-1">
            {user?.role === 'Student'
        ...
        <div className="flex gap-3 w-full md:w-auto">
          {user?.role === 'Student' && (
            <button
              ...
              className="px-6 py-2.5 bg-rose-600 hover:bg-rose-500 text-white font-black rounded-xl transition-all shadow-lg shadow-rose-200/50 uppercase text-xs tracking-widest flex items-center gap-2"
            >
          ...
          <div className="bg-white/40 dark:bg-slate-900 rounded-xl border border-rose-200/30 dark:border-slate-700 p-1 flex">
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${viewMode === 'list'
                ...
                : 'text-rose-700/60 dark:text-slate-400 hover:text-rose-900'
                }`}
            >
              List
            </button>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white/40 dark:bg-slate-900 rounded-3xl border border-rose-100/50 dark:border-white/5 p-5 shadow-xl shadow-rose-200/5 backdrop-blur-md group hover:border-rose-400 dark:hover:border-indigo-500/30 transition-all">
          <div className="flex justify-between items-center text-left">
            <div>
              <p className="text-[9px] font-black text-rose-700/40 dark:text-slate-500 uppercase tracking-widest mb-1.5">Pending Request</p>
        ...
        <div className="bg-white/40 dark:bg-slate-900 rounded-3xl border border-rose-100/50 dark:border-white/5 p-5 shadow-xl shadow-rose-200/5 backdrop-blur-md group hover:border-rose-400 dark:hover:border-indigo-500/30 transition-all">
          <div className="flex justify-between items-center text-left">
            <div>
              <p className="text-[9px] font-black text-rose-700/40 dark:text-slate-500 uppercase tracking-widest mb-1.5">Approved Sync</p>
              <p className="text-2xl font-black text-rose-600 dark:text-rose-400">
                {appointments.filter(a => a.status === 'Approved').length}
              </p>
            </div>
            <div className="w-12 h-12 rounded-2xl bg-rose-500/10 flex items-center justify-center text-rose-500 border border-rose-500/10 group-hover:scale-110 transition-transform">
        ...
        <div className="bg-white/40 dark:bg-slate-900 rounded-3xl border border-rose-100/50 dark:border-white/5 p-5 shadow-xl shadow-rose-200/5 backdrop-blur-md group hover:border-rose-400 dark:hover:border-indigo-500/30 transition-all">
          <div className="flex justify-between items-center text-left">
            <div>
              <p className="text-[9px] font-black text-rose-700/40 dark:text-slate-500 uppercase tracking-widest mb-1.5">Compl. Missions</p>
        ...
        <div className="bg-white/40 dark:bg-slate-900 rounded-3xl border border-rose-100/50 dark:border-white/5 p-5 shadow-xl shadow-rose-200/5 backdrop-blur-md group hover:border-rose-400 dark:hover:border-indigo-500/30 transition-all">
          <div className="flex justify-between items-center text-left">
            <div>
              <p className="text-[9px] font-black text-rose-700/40 dark:text-slate-500 uppercase tracking-widest mb-1.5">Total Docket</p>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-white/60 dark:bg-slate-900 border border-rose-200/50 dark:border-white/10 rounded-2xl text-rose-900 dark:text-white placeholder:text-rose-300 dark:placeholder:slate-600 focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all font-bold text-xs uppercase tracking-widest"
            />
          </div>
          <select
            value={filterStatus}
            onChange={(e) => setFilterStatus(e.target.value)}
            className="px-6 py-3 bg-white/60 dark:bg-slate-900 border border-rose-200/50 dark:border-white/10 rounded-2xl text-rose-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all font-black text-[10px] uppercase tracking-widest appearance-none cursor-pointer min-w-[160px]"
          >
            ...
            <div className="bg-white/40 dark:bg-slate-900 rounded-3xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-1">
                  <button className="p-1.5 hover:bg-rose-100 dark:hover:bg-slate-800 rounded-lg text-rose-400 hover:text-rose-600 transition-colors">
                  ...
                  <span
                    ...
                    className={`p-2 rounded-xl text-xs font-bold cursor-pointer transition-all ${day.isCurrentMonth
                      ? day.isToday
                        ...
                        : day.hasAppointments
                          ? 'text-rose-900 dark:text-slate-300 bg-white/30 dark:bg-white/5 font-black ring-1 ring-rose-200/50'
                          : 'text-rose-700/60 dark:text-slate-400 hover:bg-rose-100/50 dark:hover:bg-white/5'
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center justify-between px-2">
              ...
              {user?.role === 'Student' && (
                <button
                  onClick={() => setShowBookingForm(true)}
                  className="text-[10px] font-black text-rose-600 hover:text-rose-500 uppercase tracking-widest transition-all"
                >
                  Quick Request
                </button>
              )}
            ...
            {(getTodayAppointments().length > 0 ? getTodayAppointments() : filteredAppointments).length === 0 ? (
              ...
              (getTodayAppointments().length > 0 ? getTodayAppointments() : filteredAppointments).map((appointment) => (
                <div
                  key={appointment.id}
                  className={`bg-white/40 dark:bg-slate-900/40 p-5 rounded-2xl flex items-start gap-5 hover:bg-rose-50/60 dark:hover:bg-white/[0.02] transition-all border border-rose-200/30 dark:border-slate-700 shadow-xl shadow-rose-200/5 group border-l-[6px] ${appointment.status === 'Pending' ? 'border-l-amber-500' :
                    appointment.status === 'Approved' ? 'border-l-rose-500' :
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      ...
                      <span className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest border transition-all ${appointment.status === 'Pending' ? 'bg-amber-50 border-amber-200 text-amber-600' :
                        appointment.status === 'Approved' ? 'bg-rose-50 border-rose-200 text-rose-600' :
                          appointment.status === 'Rejected' ? 'bg-red-50 border-red-200 text-red-600' :
                            appointment.status === 'Completed' ? 'bg-emerald-50 border-emerald-200 text-emerald-600' :
                      ...
                      {user?.role === 'Teacher' && appointment.status === 'Pending' && (
                        <>
                          <button
                            ...
                            className="px-5 py-2 bg-rose-600 hover:bg-rose-500 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-rose-200/30"
                          >
                            Approve Slot
                          </button>
                          <button
                            onClick={() => handleUpdateAppointmentStatus(appointment.id, 'Rejected')}
                            className="px-5 py-2 bg-rose-100 dark:bg-slate-800 text-rose-700 dark:text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all border border-rose-200/50"
                          >
                            Decline
                          </button>
                        </>
              ...
              return (
                <div
                  ...
                  className={`min-h-[120px] p-3 rounded-2xl border transition-all ${day.isCurrentMonth
                    ...
                    } ${day.isToday ? 'ring-2 ring-rose-500 shadow-lg shadow-rose-200/50 relative z-10' : ''}`}
                >
                  ...
                  <div className="space-y-2">
                    {dayAppointments.slice(0, 3).map(appointment => (
                      <div
                        key={appointment.id}
                        className={`text-[9px] font-black p-2 rounded-lg truncate uppercase tracking-tighter ${appointment.status === 'Pending' ? 'bg-amber-100 text-amber-600 ring-1 ring-amber-200' :
                          appointment.status === 'Approved' ? 'bg-rose-100 text-rose-600 ring-1 ring-rose-200' :
                            appointment.status === 'Rejected' ? 'bg-red-100 text-red-600 ring-1 ring-red-200' :
                              appointment.status === 'Completed' ? 'bg-emerald-100 text-emerald-600 ring-1 ring-emerald-200' :
              ...
              <form onSubmit={(e) => { e.preventDefault(); handleBookAppointment(); }} className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white/50 dark:bg-slate-900 border border-rose-200/30 dark:border-rose-500/40 rounded-xl text-rose-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all font-bold appearance-none cursor-pointer"
                      required
                    >
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/50 dark:bg-slate-900 border border-rose-200/30 dark:border-rose-500/40 rounded-xl text-rose-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all font-bold"
                      required
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/50 dark:bg-slate-900 border border-rose-200/30 dark:border-rose-500/40 rounded-xl text-rose-900 dark:text-white placeholder-rose-200 dark:placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all font-bold"
                    required
                  />
                </div>
                ...
                <div className="flex justify-end gap-4 pt-4 border-t border-rose-50 dark:border-slate-800">
                  <button
                    type="button"
                    onClick={() => setShowBookingForm(false)}
                    className="px-6 py-3 text-[10px] font-black text-rose-700 dark:text-slate-400 uppercase tracking-widest hover:text-rose-900 transition-colors"
                  >
                    Discard
                  </button>
                  <button
                    ...
                    className="px-8 py-3 bg-rose-600 hover:bg-rose-500 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-rose-200/50 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Confirm Appointment
                  </button>
                </div>

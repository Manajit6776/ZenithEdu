...
const FeatureCard: React.FC<{ feature: Feature; index: number }> = ({ feature, index }) => {
  ...
  return (
    ...
    >
      ...
      {/* Arrow */}
      <div className="mt-5 flex items-center gap-1 text-xs text-neutral-600 group-hover:text-indigo-400 transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            >
              ...
              <button
                ...
                className="shiny-btn-lg text-sm font-semibold text-white px-6 py-3 rounded-xl"
              >
                Explore Modules
              </button>
            </motion.div>

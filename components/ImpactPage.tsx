...
const colorVariants: Record<string, { bg: string; text: string; border: string; gradient: string }> = {
  rose:   { bg: 'bg-rose-500/10 dark:bg-indigo-600/15',   text: 'text-rose-600 dark:text-indigo-400',   border: 'border-rose-100 dark:border-indigo-500/20',   gradient: 'from-rose-500 to-rose-700' },
  emerald:{ bg: 'bg-emerald-500/10 dark:bg-indigo-600/15', text: 'text-emerald-600 dark:text-indigo-400', border: 'border-rose-100 dark:border-indigo-500/20', gradient: 'from-emerald-500 to-emerald-700' },
  indigo: { bg: 'bg-blue-500/10 dark:bg-indigo-600/15', text: 'text-blue-600 dark:text-indigo-400', border: 'border-rose-100 dark:border-indigo-500/20', gradient: 'from-blue-500 to-blue-700' },
  amber:  { bg: 'bg-amber-500/10 dark:bg-indigo-600/15',   text: 'text-amber-600 dark:text-indigo-400',   border: 'border-rose-100 dark:border-indigo-500/20',   gradient: 'from-amber-500 to-amber-700' },
  violet: { bg: 'bg-indigo-500/10 dark:bg-indigo-600/15', text: 'text-indigo-600 dark:text-indigo-400', border: 'border-rose-100 dark:border-indigo-500/20', gradient: 'from-indigo-500 to-indigo-700' },
  teal:   { bg: 'bg-teal-500/10 dark:bg-indigo-600/15',     text: 'text-teal-600 dark:text-indigo-400',     border: 'border-rose-100 dark:border-indigo-500/20',     gradient: 'from-teal-500 to-teal-700' },
};
      ...
      <section className="relative pt-20 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <motion.p
            ...
            className="text-lg text-rose-950/60 dark:text-indigo-400/60 max-w-2xl mx-auto font-black uppercase tracking-tight"
          >
      ...
      <section className="bg-slate-50 dark:bg-slate-900/40 border-y border-slate-100 dark:border-white/5 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-600 dark:text-slate-400 max-w-xl mx-auto">Real institutions, real transformations. Here's what they said after deploying ZenithEdu.</p>
          </div>
            ...
            {timeline.map((t, i) => (
              ...
              >
                ...
                <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-white/8 rounded-2xl p-5 flex-1 hover:shadow-lg transition-shadow">
                  <span className="text-[10px] font-black text-rose-600 dark:text-indigo-400 uppercase tracking-wider">{t.year}</span>

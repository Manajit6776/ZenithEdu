...
const TeacherAnalytics = () => {
  ...
  if (user?.role !== "Admin" && user?.role !== "Teacher") {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center max-w-md mx-auto p-12 bg-white/40 dark:bg-slate-900/60 rounded-[3rem] border border-rose-100 dark:border-white/5 shadow-2xl backdrop-blur-3xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-rose-500/5 blur-3xl rounded-full -mr-16 -mt-16"></div>
          <div className="inline-flex items-center justify-center w-24 h-24 bg-rose-500/10 dark:bg-rose-500/10 rounded-[2rem] mb-8 border border-rose-500/10">
            <Shield className="w-12 h-12 text-rose-600 dark:text-rose-400" />
          </div>
  ...
  const renderOverview = () => (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white/40 dark:bg-rose-500/10 p-6 rounded-2xl border border-rose-200/30 dark:border-rose-500/20 hover:border-rose-400 dark:hover:border-rose-500/40 transition-all duration-300 group hover:scale-[1.02] shadow-xl shadow-rose-200/10">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-rose-700/60 dark:text-slate-400 mb-2 uppercase tracking-widest">Total Students</p>
            ...
            <div className="p-3 bg-rose-100 dark:bg-rose-500/20 rounded-xl group-hover:bg-rose-200 dark:group-hover:bg-rose-500/30 transition-colors">
              <Users className="w-6 h-6 text-rose-700 dark:text-rose-400" />
            </div>
          </div>
        </div>

        <div className="bg-white/40 dark:bg-amber-500/10 p-6 rounded-2xl border border-amber-200/30 dark:border-amber-500/20 hover:border-amber-400 dark:hover:border-amber-500/40 transition-all duration-300 group hover:scale-[1.02] shadow-xl shadow-amber-200/10">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-rose-700/60 dark:text-slate-400 mb-2 uppercase tracking-widest">Avg Attendance</p>
            ...
            <div className="p-3 bg-amber-100 dark:bg-amber-500/20 rounded-xl group-hover:bg-amber-200 dark:group-hover:bg-amber-500/30 transition-colors">
              <TrendingUp className="w-6 h-6 text-amber-600 dark:text-amber-400" />
            </div>
          </div>
        </div>

        <div className="bg-white/40 dark:bg-purple-500/10 p-6 rounded-2xl border border-rose-200/30 dark:border-purple-500/20 hover:border-rose-400 dark:hover:border-purple-500/40 transition-all duration-300 group hover:scale-[1.02] shadow-xl shadow-rose-200/10">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-rose-700/60 dark:text-slate-400 mb-2 uppercase tracking-widest">Avg CGPA</p>
            ...
            <div className="p-3 bg-purple-100 dark:bg-purple-500/20 rounded-xl group-hover:bg-purple-200 dark:group-hover:bg-purple-500/30 transition-colors">
        ...
        <div className="bg-white/40 dark:bg-rose-500/10 p-6 rounded-2xl border border-rose-200/30 dark:border-rose-500/20 hover:border-rose-400 dark:hover:border-rose-500/40 transition-all duration-300 group hover:scale-[1.02] shadow-xl shadow-rose-200/10">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-rose-700/60 dark:text-slate-400 mb-2 uppercase tracking-widest">High Risk</p>
            ...
            <div className="p-3 bg-rose-100 dark:bg-rose-500/20 rounded-xl group-hover:bg-rose-200 dark:group-hover:bg-rose-500/30 transition-colors">
              <AlertTriangle className="w-6 h-6 text-rose-700 dark:text-rose-400" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="p-2.5 bg-rose-100 dark:bg-slate-800 hover:bg-rose-200 dark:hover:bg-slate-700 rounded-lg text-rose-700 dark:text-slate-300 transition-colors"
            >
              {viewMode === 'grid' ? <PieChart className="w-5 h-5" /> : <BarChart3 className="w-5 h-5" />}
            </button>
            <button
              onClick={exportAnalyticsData}
              className="flex items-center space-x-2 px-4 py-2.5 bg-rose-600 hover:bg-rose-500 text-white font-black rounded-lg transition-colors shadow-lg shadow-rose-200/20"
            >
        ...
        {viewMode === 'grid' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {departmentStats.map((dept) => (
              <div
                key={dept.department}
                className="bg-white/40 dark:bg-slate-800/50 rounded-xl p-5 hover:bg-rose-50/60 dark:hover:bg-slate-800/70 transition-all duration-300 border border-rose-200/30 dark:border-slate-700 hover:border-rose-400 dark:hover:border-slate-600 group"
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-rose-500 rounded-full group-hover:animate-pulse"></div>
                    <h4 className="font-black text-rose-900 dark:text-white">{dept.department}</h4>
                  </div>
                  <span className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest">{dept.studentCount} students</span>
                </div>

                <div className="space-y-4">
                  <div className="grid grid-cols-3 gap-3">
                    <div className="text-center p-3 bg-white/30 dark:bg-slate-900/50 rounded-lg">
                      <p className="text-2xl font-black text-rose-700 dark:text-rose-300">{dept.avgCGPA.toFixed(2)}</p>
                      <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 mt-1 uppercase">CGPA</p>
                    </div>
                    <div className="text-center p-3 bg-amber-100/30 dark:bg-slate-900/50 rounded-lg">
                      <p className="text-2xl font-black text-amber-700 dark:text-amber-300">{dept.avgAttendance.toFixed(1)}%</p>
                      <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 mt-1 uppercase">Attendance</p>
                    </div>
                    <div className="text-center p-3 bg-white/30 dark:bg-slate-900/50 rounded-lg">
                      <p className="text-2xl font-black text-purple-700 dark:text-purple-300">{dept.avgAssignmentScore.toFixed(1)}%</p>
                      <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 mt-1 uppercase">Assignments</p>
                    </div>
                  </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-rose-100 dark:border-slate-700 bg-white/30 dark:bg-white/5">
              ...
              <tbody>
                {departmentStats.map((dept) => (
                  <tr key={dept.department} className="border-b border-rose-50 dark:border-slate-800 hover:bg-rose-100/20 dark:hover:bg-slate-800/30 transition-colors group">
                    <td className="py-4 px-4 font-black text-black dark:text-white group-hover:text-rose-700 dark:group-hover:text-rose-400 transition-colors">{dept.department}</td>
                    <td className="py-4 px-4 text-slate-600 dark:text-slate-300 font-bold">{dept.studentCount}</td>
                    <td className="py-4 px-4">
                      <span className="font-black text-blue-700 dark:text-blue-300">{dept.avgCGPA.toFixed(2)}</span>
                    </td>
                    <td className="py-4 px-4">
                    ...
                    <td className="py-4 px-4">
                      <span className="font-black text-rose-600 dark:text-red-400">{dept.riskDistribution.high}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={level} className="group">
                      ...
                      <div className="h-3 bg-rose-100 dark:bg-slate-700 rounded-full overflow-hidden">
                        <div
        ...
        <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
          ...
          <div className="space-y-4">
            <button className="w-full p-4 bg-white/40 dark:bg-indigo-600/20 hover:bg-rose-200/50 dark:hover:bg-indigo-600/30 border border-rose-200/30 dark:border-indigo-500/30 rounded-xl text-left group transition-all duration-300">
            ...
            <button className="w-full p-4 bg-white/40 dark:bg-rose-600/20 hover:bg-rose-200/50 dark:hover:bg-rose-600/30 border border-rose-200/30 dark:border-rose-500/30 rounded-xl text-left group transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center space-x-3 mb-1">
                ...
                <ChevronRight className="w-5 h-5 text-rose-400 group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors" />
              </div>
            </button>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="w-full px-4 py-3 pl-11 bg-white/50 dark:bg-slate-800/50 border border-rose-200/30 dark:border-slate-600 rounded-xl text-black dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-rose-500 dark:focus:ring-indigo-500 focus:border-transparent cursor-pointer flex items-center justify-between hover:border-rose-400 dark:hover:border-slate-500 transition-all font-bold"
              >
                ...
                <div className="absolute z-50 w-full mt-2 bg-slate-800 rounded-xl border border-slate-700 shadow-2xl max-h-60 overflow-y-auto">
                  {classPredictions.map((pred) => (
                    <button
                      ...
                      className="w-full px-4 py-3 text-left hover:bg-slate-700/50 transition-colors border-b border-slate-700/50 last:border-b-0 flex items-center justify-between group"
                    >
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-11 bg-white/50 dark:bg-slate-800/50 border border-rose-200/30 dark:border-slate-600 rounded-xl text-black dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-rose-500 dark:focus:ring-indigo-500 focus:border-transparent hover:border-rose-400 dark:hover:border-slate-500 transition-all font-bold placeholder:text-rose-300 dark:placeholder:text-slate-500"
              />
              <div className="absolute left-3 top-1/2 transform -translate-y-1/2">
              ...
              {(['all', 'low', 'medium', 'high'] as const).map((filter) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-xs font-black transition-all uppercase tracking-widest ${riskFilter === filter
                    ...
                    : 'bg-rose-100/50 dark:bg-slate-800 text-rose-700 dark:text-slate-400 hover:bg-rose-200 dark:hover:bg-slate-700'
                    }`}
                >
          ...
          <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
            ...
            <div className="mb-8">
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-white/40 dark:bg-rose-500/10 border border-rose-200/30 dark:border-rose-500/20 rounded-xl p-4 shadow-sm">
                  <p className="text-3xl font-black text-rose-700 dark:text-red-400">{selectedClassPrediction.risk_distribution.high}</p>
                  <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest">High Risk</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { risk: 'high', count: selectedClassPrediction.risk_distribution.high, color: 'red' }
              ...
              {paginatedStudents.length > 0 ? (
                <>
                  {paginatedStudents.map((student) => (
                    <div
                      ...
                      className="group bg-white/40 dark:bg-slate-800/30 hover:bg-rose-50/60 dark:hover:bg-slate-800/50 rounded-xl p-4 border border-rose-200/30 dark:border-slate-700 hover:border-rose-400 dark:hover:border-slate-600 cursor-pointer transition-all duration-300"
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <div className="relative">
                            ...
                            <div className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-2 border-white dark:border-slate-800 ${student.prediction.risk === 'high' ? 'bg-rose-500' :
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="text-right">
                            ...
                            <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 mt-1 uppercase tracking-tighter">
                  ...
                  {/* Pagination */}
                  {totalPages > 1 && (
                    <div className="flex items-center justify-between mt-8 pt-6 border-t border-rose-200/30 dark:border-slate-700">
                      <button
                        onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
                        disabled={currentPage === 1}
                        className="px-5 py-2.5 bg-rose-100 dark:bg-slate-800 hover:bg-rose-200 dark:hover:bg-slate-700 text-rose-700 dark:text-slate-300 font-black text-xs uppercase rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                      >
                        Previous
                      </button>
                ...
                <div className="text-center py-12">
                  ...
                  <button
                    ...
                    className="px-8 py-3 bg-rose-600 hover:bg-rose-500 text-white font-black rounded-xl transition-all shadow-lg shadow-rose-200/50 uppercase text-xs tracking-widest"
                  >
                    Clear Filters
                  </button>
                </div>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-6">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex items-center space-x-2 text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-tighter">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-3 bg-white/50 dark:bg-slate-900 border border-rose-200/30 dark:border-indigo-500/40 rounded-xl text-rose-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 dark:focus:ring-indigo-500 appearance-none cursor-pointer hover:border-rose-400 dark:hover:border-indigo-400 transition-all font-bold"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
          <div className="flex items-center justify-between">
            ...
            <div className="p-3 bg-rose-100 dark:bg-blue-500/20 rounded-xl">
              <Users className="w-6 h-6 text-rose-600 dark:text-blue-400" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest mb-1">Anomalies</p>
        ...
        <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest mb-1">High Severity</p>
              <p className="text-3xl font-black text-rose-600 dark:text-red-400">
                {filteredAnomaliesForAttendance.filter(a => a.anomaly_detection.anomaly && a.anomaly_detection.severity === 'high').length}
              </p>
            </div>
            <div className="p-3 bg-rose-50 dark:bg-red-500/20 rounded-xl">
        ...
        <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest mb-1">Progress</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 shadow-xl shadow-rose-200/5">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className={`px-6 py-2.5 rounded-xl font-black text-xs uppercase tracking-widest flex items-center space-x-2 transition-all shadow-lg ${analyzingStudents.size > 0
                    ? 'bg-rose-100 dark:bg-slate-700 text-rose-400 dark:text-slate-400 cursor-not-allowed'
                    : 'bg-rose-600 hover:bg-rose-500 text-white shadow-rose-200/50'
                    }`}
                >
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
              {filteredStudentsForAttendance.map((student) => {
                ...
                return (
                  <div key={student.student_id} className="group bg-white/40 dark:bg-slate-800/30 hover:bg-rose-50/60 dark:hover:bg-slate-800/50 rounded-xl p-4 border border-rose-200/30 dark:border-slate-700 hover:border-rose-400 dark:hover:border-slate-600 transition-all duration-300">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <div className="relative">
                          <div className="w-12 h-12 bg-rose-100 dark:bg-slate-700 rounded-xl flex items-center justify-center group-hover:bg-rose-200 transition-colors">
                            <span className="text-rose-700 dark:text-slate-300 font-black text-lg">
                              {student.student_name.charAt(0).toUpperCase()}
                            </span>
                          </div>
                          {anomaly && anomaly.anomaly_detection.anomaly && (
                            <div className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-2 border-white dark:border-slate-800 ${anomaly.anomaly_detection.severity === 'high' ? 'bg-rose-500' :
                              anomaly.anomaly_detection.severity === 'medium' ? 'bg-amber-500' : 'bg-blue-500'
                              }`}></div>
                          )}
                        </div>
                        <div>
                          <h4 className="font-black text-rose-900 dark:text-white group-hover:text-rose-700 transition-colors">{student.student_name}</h4>
                          <div className="flex items-center space-x-3 mt-1">
                            <span className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest">{student.roll_no}</span>
                            <span className="text-[10px] px-2 py-0.5 bg-rose-100/50 dark:bg-slate-700 rounded font-black text-rose-800 dark:text-slate-400 uppercase tracking-tighter">{student.department}</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center space-x-3">
                        {/* Status Badges */}
                        {!anomaly && !isAnalyzing && (
                          <span className="text-[10px] px-2 py-1 bg-rose-100 dark:bg-slate-700 rounded text-rose-700 dark:text-slate-300 font-black uppercase tracking-widest">
                            Ready
                          </span>
                        )}

                        {isAnalyzing && (
                          <span className="text-[10px] px-2 py-1 bg-rose-600/10 text-rose-600 rounded font-black uppercase tracking-widest animate-pulse">
                            Processing
                          </span>
                        )}
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-black text-xs uppercase tracking-widest transition-all flex items-center space-x-2 ${isAnalyzing
                            ? 'bg-rose-100 dark:bg-slate-700 text-rose-400 dark:text-slate-400 cursor-not-allowed shadow-none'
                            : anomaly
                              ? 'bg-rose-100 dark:bg-slate-800 text-rose-700 dark:text-white hover:bg-rose-200 border border-rose-200/50'
                              : 'bg-rose-600 text-white hover:bg-rose-500 shadow-lg shadow-rose-200/50'
                            }`}
                        >
                          {isAnalyzing ? (
                            <Loader2 className="w-4 h-4 animate-spin" />
                    ...
                    {anomaly?.anomaly_detection?.timestamp && (
                      <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 mt-2 uppercase tracking-widest">
        ...
        {/* Anomalies Summary */}
        <div>
          <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-6 sticky top-6 shadow-xl shadow-rose-200/5">
            ...
            {filteredAnomaliesForAttendance.filter(a => a.anomaly_detection.anomaly).length === 0 ? (
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest">Total Detected</span>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs font-bold text-rose-900 dark:text-slate-300 uppercase tracking-widest">Critical</span>
                      </div>
                ...
                <div className="pt-6 border-t border-rose-200/30 dark:border-slate-700">
                  <h4 className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest mb-3">Common Patterns</h4>
                    ...
                    {Object.entries(
                      ...
                      .map(([pattern, count]) => (
                        <div key={pattern} className="flex items-center justify-between text-[11px] font-bold uppercase tracking-tight group">
                          <span className="text-rose-900/60 dark:text-slate-400 truncate group-hover:text-rose-800 transition-colors">{pattern.replace(/_/g, ' ')}</span>
                          <span className="text-rose-900 dark:text-slate-300 bg-rose-100/50 dark:bg-slate-800 px-1.5 py-0.5 rounded">{count}</span>
                        </div>
                      ))}
                  </div>
                </div>
                ...
                <button
                  onClick={exportAnalyticsData}
                  className="w-full mt-6 px-4 py-3 bg-rose-100 dark:bg-slate-800 hover:bg-rose-200 dark:hover:bg-slate-700 text-rose-700 dark:text-slate-300 font-black text-xs uppercase tracking-widest rounded-xl transition-all flex items-center justify-center space-x-2 border border-rose-200/50"
                >
                  <Download className="w-4 h-4" />
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
        ...
        <p className="text-rose-800 dark:text-slate-500 animate-pulse font-black uppercase text-xs tracking-widest">Loading Analytics Dashboard</p>
        <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-tighter">Preparing your data visualization...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="bg-white/40 dark:bg-rose-900/20 rounded-2xl border border-rose-200/30 dark:border-rose-700/30 p-8 shadow-xl shadow-rose-200/5">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="px-8 py-3 bg-rose-100 dark:bg-slate-800 hover:bg-rose-200 dark:hover:bg-slate-700 text-rose-700 dark:text-slate-300 font-black rounded-xl transition-all uppercase text-xs tracking-widest border border-rose-200/50"
              >
                Use Demo Data
              </button>
            </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex items-center space-x-3">
          <div className="hidden lg:block text-right">
            <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest">Welcome back,</p>
            <p className="font-black text-rose-900 dark:text-white">{user?.name || 'Teacher'}</p>
          </div>
          <button
            onClick={exportAnalyticsData}
            className="flex items-center space-x-2 px-8 py-3 bg-rose-600 hover:bg-rose-500 text-white font-black rounded-xl transition-all shadow-lg shadow-rose-200/50 uppercase text-xs tracking-widest"
          >
      ...
      {/* Tab Navigation */}
      <div className="bg-white/40 dark:bg-slate-900 rounded-2xl border border-rose-200/30 dark:border-slate-700 p-2 shadow-xl shadow-rose-200/5">
          ...
          {[
            ...
            <button
              ...
              className={`flex-1 px-6 py-4 rounded-xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center space-x-3 ${activeTab === tab.id
                ? 'bg-rose-600 text-white shadow-lg shadow-rose-200/50'
                : 'text-rose-700/60 dark:text-slate-400 hover:text-rose-900 hover:bg-rose-100 dark:hover:bg-slate-800/50'
                }`}
            >
      ...
      {selectedStudent && (
        <div className="fixed inset-0 bg-rose-900/40 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-in fade-in duration-300">
          <div className="bg-white/90 dark:bg-slate-900 rounded-3xl border border-rose-200/50 dark:border-slate-700 w-full max-w-md max-h-[90vh] overflow-hidden shadow-2xl animate-in zoom-in duration-300">
            <div className="p-8 border-b border-rose-100 dark:border-slate-800 relative bg-rose-50/50 dark:bg-slate-900">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-black text-rose-800 dark:text-white uppercase tracking-tight">{selectedStudent.student_name}</h3>
                  <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest mt-1">{selectedStudent.roll_no}</p>
                </div>
                <button
            ...
            <div className="p-8 space-y-8 overflow-y-auto max-h-[60vh] custom-scrollbar">
              <div>
                <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest mb-4">Performance Assessment</p>
              ...
              <div>
                <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest mb-4">Key Risk Factors</p>
                <div className="space-y-3">
                  {selectedStudent.prediction.factors.map((factor, index) => (
                    <div key={index} className="flex items-center space-x-3 p-4 bg-rose-50/60 dark:bg-slate-800/50 rounded-2xl border border-rose-100/50 dark:border-slate-700/50 transition-all hover:bg-rose-100/50">
              ...
              <div>
                <p className="text-[10px] font-bold text-rose-700/60 dark:text-slate-400 uppercase tracking-widest mb-4">Strategic Interventions</p>
                <div className="space-y-4">
                  <div className="p-4 bg-white/40 dark:bg-indigo-600/10 border border-rose-200/50 dark:border-indigo-500/20 rounded-2xl group hover:bg-rose-100/60 transition-all">
                    ...
                    <p className="text-xs font-medium text-rose-700/70 dark:text-rose-300">Address identified risk factors in a focused session</p>
                  </div>
            ...
            <div className="p-8 border-t border-rose-100 dark:border-slate-800 bg-rose-50/20 dark:bg-slate-900">
              <button
                onClick={() => setSelectedStudent(null)}
                className="w-full px-8 py-4 bg-rose-600 hover:bg-rose-500 text-white font-black rounded-2xl transition-all shadow-lg shadow-rose-200/50 uppercase text-sm tracking-widest"
              >
                Done
              </button>
            </div>

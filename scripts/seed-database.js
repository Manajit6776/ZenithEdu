...
async function main() {
  ...
  const students = [
    {
      name: 'John Smith',
      email: 'john.smith@zenithedu.com',
      rollNo: 'CS2021001',
      department: 'Computer Science',
      attendance: 85.5,
      cgpa: 3.8,
    ...
    {
      name: 'Emily Johnson',
      email: 'emily.johnson@zenithedu.com',
      rollNo: 'CS2021002',
      department: 'Computer Science',
      attendance: 92.0,
      cgpa: 3.9,
    ...
    {
      name: 'Sarah Davis',
      email: 'sarah.davis@zenithedu.com',
      rollNo: 'PH2021001',
      department: 'Physics',
      attendance: 95.0,
      cgpa: 3.7,
    ...
    {
      name: 'James Wilson',
      email: 'james.wilson@zenithedu.com',
      rollNo: 'PH2021002',
      department: 'Physics',
      attendance: 88.0,
      cgpa: 3.6,
    ...
    {
      name: 'Lisa Anderson',
      email: 'lisa.anderson@zenithedu.com',
      rollNo: 'CH2021001',
      department: 'Chemistry',
      attendance: 91.5,
      cgpa: 3.5,
    ...
    {
      name: 'Robert Taylor',
      email: 'robert.taylor@zenithedu.com',
      rollNo: 'CH2021002',
      department: 'Chemistry',
      attendance: 82.0,
      cgpa: 3.3,
    ...
    },
    {
      ...
      email: 'jennifer.martinez@zenithedu.com',
      rollNo: 'CS2021004',
      department: 'Computer Science',
      attendance: 96.0,
      cgpa: 4.0,

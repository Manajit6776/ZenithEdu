...
const AppLayout = () => {
  ...
  const allNavItems = useMemo(() => {
    ...
    // Add virtual items for sub-pages in Academics
    items.push(
      { label: 'Courses', icon: BookOpen, to: '/academics?tab=courses', section: 'Academic' },
      { label: 'Assignments', icon: FileText, to: '/academics?tab=assignments', section: 'Academic' },
      { label: 'Academic Plan', icon: GraduationCap, to: '/academics?tab=plan', section: 'Academic' },
      { label: 'Learning Notes', icon: Library, to: '/academics?tab=notes', section: 'Academic' }
    );
